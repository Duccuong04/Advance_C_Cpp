...
int stringCompare(const char *str1, const char *str2) {   //pointer to constant
   while (*str1 && (*str1 == *str2)) {                    //hoa, hoang
       str1++;
       str2++;
   }
   return *(const unsigned char*)str1 - *(const unsigned char*)str2; // 0 - , 0 - 255
}
